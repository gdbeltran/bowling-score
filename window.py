def game_window(game_number):
    ...
    window.title(f"Bowling Score - Game {game_number}")
    window_width = 625
    window_height = 150
    ...
    frame1.place(x=0, y=0, width=60, height=70)
    ...
    f6b1 = ttk.Entry(frame6, width=3)
    f6b1.grid(row=1, column=0)
    f6b2 = ttk.Entry(frame6, width=3)
    f6b2.grid(row=1, column=1)
    f6score = ttk.Label(frame6, textvariable=f6score_var)
    f6score.grid(row=2, column=1)
    frame6.place_forget()

    # frame 7
    frame7 = ttk.Frame(window, relief="solid", borderwidth=1)
    frame7.place(x=360, y=0, width=60, height=70)
    ...
    f7b1 = ttk.Entry(frame7, width=3)
    f7b1.grid(row=1, column=0)
    f7b2 = ttk.Entry(frame7, width=3)
    f7b2.grid(row=1, column=1)
    f7score = ttk.Label(frame7, textvariable=f7score_var)
    f7score.grid(row=2, column=1)
    frame7.place_forget()

    # frame 8
    frame8 = ttk.Frame(window, relief="solid", borderwidth=1)
    frame8.place(x=420, y=0, width=60, height=70)
    ...
    f8b1 = ttk.Entry(frame8, width=3)
    f8b1.grid(row=1, column=0)
    f8b2 = ttk.Entry(frame8, width=3)
    f8b2.grid(row=1, column=1)
    f8score = ttk.Label(frame8, textvariable=f8score_var)
    f8score.grid(row=2, column=1)
    frame8.place_forget()

    # frame 9
    frame9 = ttk.Frame(window, relief="solid", borderwidth=1)
    frame9.place(x=480, y=0, width=60, height=70)
    ...
    f9b1 = ttk.Entry(frame9, width=3)
    f9b1.grid(row=1, column=0)
    f9b2 = ttk.Entry(frame9, width=3)
    f9b2.grid(row=1, column=1)
    f9score = ttk.Label(frame9, textvariable=f9score_var)
    f9score.grid(row=2, column=1)
    frame9.place_forget()

    # frame 10
    frame10 = ttk.Frame(window, relief="solid", borderwidth=1)
    frame10.place(x=540, y=0, width=85, height=70)
    ...
    f10b1 = ttk.Entry(frame10, width=3)
    f10b1.grid(row=1, column=0)
    f10b2 = ttk.Entry(frame10, width=3)
    f10b2.grid(row=1, column=1)
    f10b3 = ttk.Entry(frame10, width=3)
    f10b3.grid(row=1, column=2)
    f10score = ttk.Label(frame10, textvariable=f10score_var)
    f10score.grid(row=2, column=2)
    frame10.place_forget()

    def end_frame():
        nonlocal frame_number, frames
    ...
    window.bind('<KP_Enter>', key_return)
